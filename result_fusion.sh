...
--output_folder 'outputs/cityscapes/train_fusion_gta_4' \
--segmentation_folder '/media/ywh/1/yanweihao/projects/uda/DAFormer/work_dirs/local-exp7/230524_2319_gta2cs_dacs_a999_fdthings_rcs001_cpl_daformer_sepaspp_mitb5_poly10warm_s0_6283e/pred_trainid' \
...
# python result_fusion.py \
# --mask_folder '/media/ywh/1/yanweihao/projects/segmentation/segment-anything/outputs/cityscapes/train2' \
# --output_folder 'outputs/cityscapes/train_fusion_syn2' \
# --segmentation_folder '/media/ywh/1/yanweihao/projects/uda/DAFormer/work_dirs/local-exp7/230526_1633_syn2cs_dacs_a999_fdthings_rcs001_cpl_daformer_sepaspp_mitb5_poly10warm_s0_103e3/pred_trainid' \
# --image_folder '/media/ywh/1/yanweihao/dataset/cityscapes_original/gtFine_trainvaltest/leftImg8bit/train_all' \
# --mask_suffix '.png' \
